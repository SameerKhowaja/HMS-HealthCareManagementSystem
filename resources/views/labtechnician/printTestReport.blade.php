        ...
        <div>
            <div style='margin-top: 2%; margin-bottom: 3%; '>
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <h3 class="text-large text-grey">Lab Technician / Patient / Print Test Report</h3>
                    <button id='reportPrint' class="btn btn-primary btn-lg active" role="button" aria-pressed="true"><i class="fa fa-print"> </i> Print</button>
                </div>
                <br>
