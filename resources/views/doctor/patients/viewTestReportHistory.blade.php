...
<div class="container-fluid">
    <div style="display: flex; justify-content: space-between; align-items: center; height:10rem;" >
        <div style="display:inline;">
            <h2>Doctor / Patient / Lab Test History</h2>
        </div>
            ...
            <div class="tracking-list">
               <div class="tracking-item">
                  ...
                  <div class="tracking-content">
                      ...
                      <div class="text-large">
                        <a href="/doctor/patient/lab-test/printTestReport/{{$hist->report_id}}" class="btn btn-primary btn-lg" ><i class="fa fa-file fa-lg" ></i> Report</a>
                      </div>
