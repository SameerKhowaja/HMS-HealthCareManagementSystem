...
@section('content')
    @if($userData->viewRoomBed == 1)
    <div>
        <section id="overview">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <h3 class="text-large text-grey">Other / Rooms & Bed Manager</h3>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12" style='margin-bottom:2%;'>
                    ...
                    <div class="table-responsive" style='box-shadow: 5px 3px 5px 3px #1b99d8; background-color: white; padding: 2%; border-radius: 20px; font-size: 13px;'>
                        <div class="row">
                            <div class="col-lg-7">
                                @if($userData->editRoomBed == 1 || $userData->deleteRoomBed == 1)
                        ...
                        @if($userData->createRoomBed == 1 || $userData->editRoomBed == 1 || $userData->deleteRoomBed == 1)
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <form action="/other/room-bed-management" method="POST">
                                @csrf
        ...
        <div class="modal fade" id="addNewRoom_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                <div class="modal-content">
                    <form action="/other/room-bed-management/add-new-room" method="POST">
                    @csrf
                        <div class="modal-body">
                            <table class="table table-hover table-borderless">
                                <thead>
        ...
        <div class="modal fade" id="addNewBed_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    <form action="/other/room-bed-management/add-new-bed" method="POST">
                    @csrf
                        <div class="modal-body">
                            <table class="table table-hover table-borderless">
                                <thead>
    ...
    <script>
        ...
        $(document).ready(function(){
            $(".editRoom").click(function(){
                ...
                $("#ok_edit_room").attr("action","/other/room-bed-management/room-edit/"+user_id);
    ...
    <script>
        $(".editBed").click(function() {
            ...
            $("#ok_edit_bed").attr("action","/other/room-bed-management/bed-edit/"+$bedID);
    ...
    <script>
        ...
        $(document).ready(function(){
            $(".deleteBed").click(function(){
                ...
                $("#ok_delete_bed").attr("action","/other/room-bed-management/bed-delete/"+user_id);
    ...
    <script>
        ...
        $(document).ready(function(){
            $(".deleteRoom").click(function(){
                ...
                $("#ok_delete_room").attr("action","/other/room-bed-management/room-delete/"+user_id);
