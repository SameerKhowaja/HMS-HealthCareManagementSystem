@if(session('userID')!==NULL && session('userType')=='other')
<!DOCTYPE html>
<html lang="en">
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <a class="dropdown-item" href="/other">Dashboard</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="/other/editOtherProfile/{{session('userID')}}">Edit Profile</a>
                                    <div class="dropdown-divider"></div>
