        ...
        <div>
            <div style='margin-top: 3%; margin-bottom: 4%;'>
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <h3 class="text-large text-grey">Doctor Details / Doctor Timing / Edit Timing</h3>
                    <a href="/receptionist/doctor-timing" role="button" class="btn btn-secondary btn-lg">Back</a>
                </div>

                <br>

                <!-- Edit Timings -->
                <div class="table-responsive col-lg-12" style='box-shadow: 5px 3px 5px 3px #1b99d8; background-color: white; padding: 2%; border-radius: 10px; font-size: 14px;'>
                    ...
                    <!-- Timings Form -->
                    <form action="/receptionist/doctor-timing/edit-timing/{{$dataFetched->doctor_available_id}}" method="POST">
                    @csrf
                        <hr>
                        <!-- If error occurs -->
                        <div class="row">
