        ...
        <div>
            <div style='margin-top: 2%; margin-bottom: 3%;'>
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <a href="/receptionist" role="button" class="btn btn-secondary btn-lg active">Back</a>
                </div>
                ...
                <div class="table-responsive" style='box-shadow: 5px 3px 5px 3px #1b99d8; background-color: white; padding: 2%; border-radius: 10px; font-size: 13px;'>
                    ...
                    <form action="/receptionist/editReceptionistProfile/{{$hospital_data->primary_id}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Head Row -->
            ...
            <div class="modal fade" id="changePassword_modal">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="/receptionist/editReceptionistProfile/editPassword/{{session('userID')}}">
                        {{csrf_field()}}
                            <!-- Modal body -->
