...
@section('content')
    <div>
        <section id="overview">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <h3 class="text-large text-grey">Receptionist / Rooms & Bed</h3>
            </div>
        ...
        <div class="modal fade" id="addNewRoom_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                <div class="modal-content">
                    <form action="/receptionist/room-bed/add-new-room" method="POST">
                    @csrf
                        <div class="modal-body">
                            <table class="table table-hover">
                                <thead>
        ...
        <div class="modal fade" id="addNewBed_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    <form action="/receptionist/room-bed/add-new-bed" method="POST">
                    @csrf
                        <div class="modal-body">
                            <table class="table table-hover">
                                <thead>
    ...
    <script>
        ...
        $(document).ready(function(){
            $(".editRoom").click(function(){
                ...
                $("#ok_edit_room").attr("action","/receptionist/room-bed/room-edit/"+user_id);
    ...
    <script>
        $(".editBed").click(function() {
            ...
            $("#ok_edit_bed").attr("action","/receptionist/room-bed/bed-edit/"+$bedID);
    ...
    <script>
        ...
        $(document).ready(function(){
            $(".deleteBed").click(function(){
                ...
                $("#ok_delete_bed").attr("action","/receptionist/room-bed/bed-delete/"+user_id);
    ...
    <script>
        ...
        $(document).ready(function(){
            $(".deleteRoom").click(function(){
                ...
                $("#ok_delete_room").attr("action","/receptionist/room-bed/room-delete/"+user_id);
