        ...
        <div>
            <div style='margin-top: 2%; margin-bottom: 3%;'>
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <h3 class="text-large text-grey">Patient Details / Patient View / Add Record</h3>
                </div>

                <!-- Table -->
                <div class="table-responsive" style='box-shadow: 5px 3px 5px 3px #1b99d8; background-color: white; padding: 2%; border-radius: 10px; font-size: 13px;'>

                    <form action="/receptionist/patient-view/addRecord" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Head Row -->
                        <div class="row" style="margin:auto;">
                            <div class="col-sm-12" style="text-align:center;">
                                <div class="form-group">
                                    <h1 class="display-4">Create New Patient Record</h1>
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                            <a href="/receptionist/patient-view" role="button" class="btn btn-secondary btn-lg active">Back</a>
