...
<header>
    <nav class="sideNav">
      ...
      <ul class="navLists">
        <a href="http://localhost/laravel/public/receptionist">
        ...
        <!-- <a href="http://localhost/laravel/public/department">
        ...
        <a href="http://localhost/laravel/public/receptionist/doctor">
          <li class="text-normal">
        ...
        <a href="http://localhost/laravel/public/receptionist/patient">
          <li class="text-normal">
            <svg xmlns="http://www.w3.org/2000/svg"
                  xmlns:xlink="http://www.w3.org/1999/xlink"
                  aria-hidden="true" focusable="false"
        ...
        <a href="http://localhost/laravel/public/receptionist/laboratorist">
          <li class="text-normal">
            <svg xmlns="http://www.w3.org/2000/svg"
                  xmlns:xlink="http://www.w3.org/1999/xlink"
                  aria-hidden="true" focusable="false"
        ...
        <!-- <a href="http://localhost/laravel/public/receptionist/receptionist">
          <li class="text-normal">
            <svg xmlns="http://www.w3.org/2000/svg"
                  xmlns:xlink="http://www.w3.org/1999/xlink"
                  aria-hidden="true" focusable="false"
        ...
        <a href="http://localhost/laravel/public/receptionist/viewAppointment">
          <li class="text-normal">
            <svg xmlns="http://www.w3.org/2000/svg"
                  xmlns:xlink="http://www.w3.org/1999/xlink"
                  aria-hidden="true" focusable="false"
