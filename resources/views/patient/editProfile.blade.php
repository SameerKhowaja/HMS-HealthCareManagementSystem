        ...
        <div>
            <div style='margin-top: 2%; margin-bottom: 3%;'>
                ...
                <div class="table-responsive" style='box-shadow: 5px 3px 5px 3px #1b99d8; background-color: white; padding: 2%; border-radius: 10px; font-size: 13px;'>
                    ...
                    <form action="/laravel/public/patient/editPatientProfile/{{$hospital_data->primary_id}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Head Row -->
            ...
            <div class="modal fade" id="changePassword_modal">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="/laravel/public/patient/editPatientProfile/editPassword/{{session('userID')}}">
                            <!-- Modal body -->
