        ...
        <div>
            <div style='margin-top: 2%; margin-bottom: 3%;'>
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <h3 class="text-large text-grey">Patient / Doctor's Appointment / Schedule Appointment</h3>
                    <button href="/laravel/public/patient/doctor-appointment" role="button" class="btn btn-secondary btn-lg active">Back</button>
                </div>
                ...
                <div class="row">
                        ...
                        <div class="table-responsive" style='box-shadow: 5px 3px 5px 3px #1b99d8; background-color: white; padding: 2%; border-radius: 10px; font-size: 13px;'>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    @else
                                        <img class="img-fluid rounded img-thumbnail mx-auto d-block rounded-circle" src='{{"data:image/*;base64,".$doctorData->image}}' alt="profile" width="150" height="150" style="margin-bottom:5px;">
                                    @endif
                                </div>
                            </div>
                            <!-- row2 -->
                                ...
                                <div class="col-sm-12">
                                    <table class="table table-hover">
                                        <tbody>
                                            ...
                                            @if($doctorData->available_timings ?? '' == '' || $doctorData->available_days ?? '' == '' || $doctorData->specialist ?? '' == '')
                                            <tr>
                                            ...
                                            <tr>
                                                <td><strong>Available Days:</strong></td>
                                                <td>{{$doctorData->available_days ?? ''}}</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Timings:</strong></td>
                                                <td>{{$doctorData->available_timings ?? ''}}</td>
                                            </tr>
                                            @endif
                                        </tbody>
                                    </table>
                    ...
                    <div class="col-md-8">
                        <div class="table-responsive" style='background-color: white; padding: 2%; border-radius: 15px; font-size: 13px;'>
                            <form action="/laravel/public/patient/editPatientProfile/" method="POST" enctype="multipart/form-data">
                                @csrf
                                <!-- Head Row -->
