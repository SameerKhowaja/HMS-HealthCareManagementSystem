        ...
        <div>
            <div style='margin-top: 2%; margin-bottom: 3%;'>
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <button href="/patient/doctor-appointment" role="button" class="btn btn-secondary btn-lg active">Back</button>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="table-responsive" style='background-color: white; padding: 2%; border-radius: 15px; font-size: 13px;'>
                            <form action="/patient/editPatientProfile/" method="POST" enctype="multipart/form-data">
                                @csrf
                                <!-- Head Row -->
