...
@section('navSection')
        ...
        <ul class="navLists">
            ...
            <a href="/patient/medical-history/{{session('userID')}}">
                <li class="text-normal">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-text" viewBox="0 0 16 16" fill="#0052E9">
                    ...
                    <div class="table-responsive" style='box-shadow: 5px 3px 5px 3px #1b99d8; background-color: white; padding: 2%; border-radius: 10px; font-size: 13px;'>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                ...
                                <a class="btn btn-primary btn-lg" style='font-size: 13px;' href="/patient/editPatientProfile/{{session('userID')}}"><i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i> Edit Profile</a>
                            </div>
                        </div>
                    </div>
