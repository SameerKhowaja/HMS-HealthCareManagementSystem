        ...
        <div>
            <div style='margin-top: 2%; margin-bottom: 3%;'>
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <h3 class="text-large text-grey">Admin / Medicine / Edit Medicine Data</h3>
                </div>

                <!-- Table -->
                <div class="table-responsive" style='box-shadow: 5px 3px 5px 3px #1b99d8; background-color: white; padding: 2%; border-radius: 10px; font-size: 13px;'>

                    <form action="/admin/medicine/edit-medicine/{{$medicine->medicine_id}}" method="POST">
                        @method("put")
                        @csrf
                        <!-- Head Row -->
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="medicine_name" value="{{$medicine->medicine}}" class="form-control form-control-lg" placeholder="Medicine Name" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <strong>Drug Used For*</strong>
                                    <textarea name="medicine_uses" id="drug_use" cols="30" rows="3" class="form-control form-control-lg" placeholder="Drug Use" required>{{$medicine->drug_use}}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                            <a href="/admin/medicine" role="button" class="btn btn-secondary btn-lg active">Back</a>
