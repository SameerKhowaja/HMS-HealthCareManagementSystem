                    ...
                    <form action="/laravel/public/admin/hospital-data/edit-record/{{$hospitalData->primary_id}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="specialist" class="form-control form-control-lg" placeholder="First Name" value="{{$doctorSpecialist ?? ''}}">
                                </div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                <a href="/laravel/public/admin/hospital-data" role="button" class="btn btn-secondary btn-lg active">Back</a>
