        ...
        <div>
            <div style='margin-top: 2%; margin-bottom: 3%;'>
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <h3 class="text-large text-grey">Admin / Laboratory Test / Add Test</h3>
                </div>

                <!-- Table -->
                <div class="table-responsive" style='box-shadow: 5px 3px 5px 3px #1b99d8; background-color: white; padding: 2%; border-radius: 10px; font-size: 13px;'>

                    <form action="/admin/lab-test/addTest" method="POST" enctype='application/json'>
                        @csrf
                        <!-- Head Row -->
                        <div class="row" style="margin:auto;">
                            <div class="col-sm-12" style="text-align:center;">
                                <div class="form-group">
                                    <h1 class="display-4">Create New Lab Test</h1>
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="test_type" class="form-control form-control-lg" placeholder="Test Type" required>
                                </div>
                            </div>
                        </div>
                        <!-- row3 -->
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="test_sample" class="form-control form-control-lg" placeholder="Test Sample eg:urine" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <strong>Methodology*</strong>
                                    <input type="text" name="methodology" class="form-control form-control-lg" placeholder="Methodology" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin:auto;">
                            <div class="col-sm-12" style="text-align:center;">
                                <div class="form-group">
                                    <h1 class="display-6">Add Test Parameters</h1>
                                </div>
                            </div>
                        </div>
                        <hr>
