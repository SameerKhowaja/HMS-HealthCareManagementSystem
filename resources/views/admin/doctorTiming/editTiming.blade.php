        ...
        <div>
                ...
                <div class="table-responsive" style='box-shadow: 5px 3px 5px 3px #1b99d8; background-color: white; padding: 2%; border-radius: 10px; font-size: 13px;'>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                            ...
                            <a class="btn btn-primary btn-lg" style='font-size: 13px;' href="/admin/hospital-data/edit-record/{{$dataFetched->primary_id}}"><i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i> Edit Profile</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style='margin-top: 3%; margin-bottom: 4%;'>
                ...
                <div class="table-responsive" style='box-shadow: 5px 3px 5px 3px #1b99d8; background-color: white; padding: 2%; border-radius: 10px; font-size: 14px;'>
                    ...
                    <form action="/admin/doctor-timing/edit-timing/{{$dataFetched->doctor_available_id}}" method="POST">
                    @csrf
                        <!-- Head Row -->
                        <div class="row" style="margin:auto;">
                            <div class="col-sm-12" style="text-align:center;">
