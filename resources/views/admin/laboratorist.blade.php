...
<header>
    <nav class="sideNav">
      ...
      <div class="logoutBtn text-normal" data-toggle="modal" data-target="#logoutModal">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" width="1em" height="1em" style="-ms-transform: rotate(360deg); -webkit-transform: rotate(360deg); transform: rotate(360deg);" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
          <g fill="none" stroke="#0052E9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <section class="topNav" style='border-bottom: 0.5px solid #88B0B9;'>
    ...
    <div style='margin-top: 2%;'>
        ...
        <div style="display: flex; justify-content: space-between; align-items: center;">
          <h3 class="text-large text-grey">Admin / Laboratorist / list</h3>
        ...
        <div class="table-responsive" style='box-shadow: 5px 3px 5px 3px #C4CACB; background-color: white; padding: 2%; border-radius: 10px; font-size: 13px;'>
              <div style="display: flex; justify-content: space-between; align-items: center;">
                  <div class="col-lg-12 margin-tb" >
                      <div class="pull-left">
                          <a class="btn btn-primary" href="http://localhost/laravel/public/admin/createLaboratorist">Add Laboratorist</a>
                      </div>
                  </div>
              </div>
          ...
          <table class="table">
            ...
            @foreach ($laboratorists as $laboratorist)
                <tr>
                    <th>{{ $loop->index+1 }}</th>
                    <td>{{ $laboratorist->tech_name }}</td>
                    <td>{{ $laboratorist->gender }}</td>
                    <td>{{ $laboratorist->DOB }}</td>
                    <td>{{ $laboratorist->CNIC }}</td>
                    <td>{{ $laboratorist->contact_no }}</td>
                    <td style='margin: 0px;'>
                    <a class="btn btn-info" style='font-size: 13px;' href="http://localhost/laravel/public/admin/showLaboratorist/{{$laboratorist->id}}">Show</a>
                    </td>
                    <td>
                    <a class="btn btn-warning" style='font-size: 13px;' href="http://localhost/laravel/public/admin/editLaboratorist/{{$laboratorist->id}}">Edit</a>
                   
                    </td>
                    
                    <td>
                        <form action="http://localhost/laravel/public/admin/deleteLaboratorist/{{$laboratorist->id}}" method="POST">
                            @csrf
                            @method('DELETE')
