  ...
  <section class="topNav" style='border-bottom: 0.5px solid #88B0B9;'>
    ...
    <div class="table-responsive" style='box-shadow: 5px 3px 5px 3px #C4CACB; background-color: white; padding: 2%; border-radius: 10px; font-size: 13px;'>
        ...
        <div style="display: flex; justify-content: space-between; align-items: center;">
                  <div class="col-lg-12 margin-tb" >
                      <div class="pull-left">
                          <a class="btn btn-primary" href="http://localhost/laravel/public/admin/patient">Back</a>
                      </div>
                  </div>
        </div>
        @if ($errors->any())
    ...
    <form action="http://localhost/laravel/public/admin/updatePatient/{{$patient->id}}" method="POST">
      @csrf
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="patient_name" class="form-control" value={{$patient->patient_name}}>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="password" name="patient_password" class="form-control" value={{$patient->patient_password}}>
                    </div>
                </div>
            </div>
            <!-- row2 -->
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="gender" name="gender" class="form-control" value={{$patient->gender}}>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <strong>Contact No</strong>
                        <input type="number" name="contact_no" class="form-control" value={{$patient->contact_no}}>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="date" name="date_admitted" class="form-control" value={{$patient->date_admitted}}>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <strong>Admission Id</strong>
                        <input type="text" name="admission_id" class="form-control" value={{$patient->admission_id}}>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        <strong>Room</strong>
                        <input type="number" name="room" class="form-control" value={{$patient->room}}>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <strong>PID</strong>
                        <input type="number" name="PID" class="form-control" value={{$patient->PID}}>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <strong>Date Discharged</strong>
                        <input type="date" name="date_discharged" class="form-control" value={{$patient->date_discharged}}>
                    </div>
                </div>
            </div>
