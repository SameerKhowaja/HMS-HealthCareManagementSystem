  ...
  <section class="topNav" style='border-bottom: 0.5px solid #88B0B9;'>
    ...
    <div style='margin-top: 2%;'>
        <div style="display: flex; justify-content: space-between; align-items: center;">
          <h3 class="text-large text-grey">Admin / add patient</h3>
        ...
        <form action="http://localhost/laravel/public/admin/addPatient" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="date" name="date_admitted" class="form-control" placeholder="Date Admitted">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <strong>Admission Id</strong>
                        <input type="text" name="admission_id" class="form-control" placeholder="Admission id">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="date" name="date_discharged" class="form-control" placeholder="Date Discharged">
                    </div>
                </div>
            </div>
