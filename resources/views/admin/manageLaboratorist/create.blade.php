  ...
  <section class="topNav" style='border-bottom: 0.5px solid #88B0B9;'>
    ...
    <div style='margin-top: 2%;'>
        <div style="display: flex; justify-content: space-between; align-items: center;">
          <h3 class="text-large text-grey">Admin / Laboratorist / add laboratorist</h3>
        ...
        <form action="http://localhost/laravel/public/admin/addLaboratorist" method="POST">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="tech_name" class="form-control" placeholder="Tech Name">
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="password" name="tech_password" class="form-control" placeholder="password">
                    </div>
                </div>
            </div>
            <!-- row2 -->
