  ...
  <section class="topNav" style='border-bottom: 0.5px solid #88B0B9;'>
    ...
    <div style='margin-top: 2%;'>
        <div style="display: flex; justify-content: space-between; align-items: center;">
          <h3 class="text-large text-grey">Admin / Laboratorist / edit</h3>
    ...
    <div class="table-responsive" style='box-shadow: 5px 3px 5px 3px #C4CACB; background-color: white; padding: 2%; border-radius: 10px; font-size: 13px;'>
        ...
        <div style="display: flex; justify-content: space-between; align-items: center;">
                  <div class="col-lg-12 margin-tb" >
                      <div class="pull-left">
                          <a class="btn btn-primary" href="http://localhost/laravel/public/admin/laboratorist">Back</a>
                      </div>
                  </div>
        </div>
        @if ($errors->any())
    ...
    <form action="http://localhost/laravel/public/admin/updateLaboratorist/{{$laboratorist->id}}" method="POST">
        @csrf
        <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        <strong>Tech Name</strong>
                        <input type="text" name="tech_name" class="form-control" value={{$laboratorist->tech_name}}>
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="password" name="tech_password" class="form-control" value={{$laboratorist->tech_password}}>
                    </div>
                </div>
            </div>
            <!-- row2 -->
            ...
            <div class="col-sm-6">
                    <div class="form-group">
                        <strong>Email</strong>
                        <input type="email" name="email" class="form-control" value={{$laboratorist->email}}>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <strong>CNIC</strong>
                        <input type="text" name="CNIC" class="form-control" value={{$laboratorist->CNIC}}>
                    </div>
                </div>
            </div>
            <!-- row3 -->
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="gender" name="gender" class="form-control" value={{$laboratorist->gender}}>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <strong>Contact No</strong>
                        <input type="number" name="contact_no" class="form-control" value={{$laboratorist->contact_no}}>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <strong>Date of Birth</strong>
                        <input type="date" name="DOB" class="form-control" value={{$laboratorist->DOB}}>
                    </div>
                </div>
            ...
            <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="form-group green-border-focus">
                            <textarea name="description" value={{$laboratorist->description}} class="form-control" rows="3"></textarea>
                      </div>
                    </div>
                </div>
